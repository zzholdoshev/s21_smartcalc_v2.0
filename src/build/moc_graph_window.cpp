...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_graph_window_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_graph_window_t qt_meta_stringdata_graph_window = {
    {
        QT_MOC_LITERAL(0, 12),  // "graph_window"
        QT_MOC_LITERAL(13, 25),  // "on_lineEdit_5_textChanged"
        QT_MOC_LITERAL(39, 0),  // ""
...
Q_CONSTINIT static const uint qt_meta_data_graph_window[] = {
...
Q_CONSTINIT const QMetaObject graph_window::staticMetaObject = { {
    ...
    qt_meta_stringdata_graph_window.offsetsAndSizes,
...
void graph_window::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_lineEdit_5_textChanged((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
